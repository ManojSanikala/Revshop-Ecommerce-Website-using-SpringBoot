  ...
  <%@ page isELIgnored="false" %>
    ...
    <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-custom">
        <div class="container-fluid p-3">
          ...
          <div class="d-flex justify-content-end">
            ...
            <c:if test="${not empty userRole && userRole == 'Buyer'}">
              <a href="/cart" class="btn ml-2">
                <i class="fas fa-shopping-cart"></i>
              </a>
              <a href="/myOrders" class="btn btn-secondary ml-2">
                <i class="fas fa-box"></i>
              </a>
              <a href="/myAccount" class="btn btn-success ml-2">
                <i class="fas fa-user"></i>
              </a>
              <a href="/wishlist" class="btn btn-info ml-2">
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="/buyerDashboard">Home</a>
            </li>
      ...
      <div class="container mt-4">
        <h2 class="welcome-message">Welcome, ${loggedInUser.name}!</h2>
          ...
          <c:forEach var="product" items="${products}">
            <div class="card custom-card">
              ...
              <div class="card-body">
                ...
                <c:if test="${product.product_stock > 0}">
                  <a href="/cart?productId=${product.product_id}" class="btn btn-primary">Cart Now</a>
